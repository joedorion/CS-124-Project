...
public final class Client {
  ...
  // Create map of restaurants and populate using getRestaurants()
        ...
        new StringRequest(
            ...
            response -> {
              ...
              try {
                ...
                // Initialize map using list of restaurants
                for (Restaurant current : restaurants) {
                  restaurantMap.put(current.getId(), current);
                }
    ...
    StringRequest preferencesRequest =
        new StringRequest(
            ...
            response -> {
              ...
              try {
                /*
                 * Deserialize the String into a List<Preferences> using Jackson.
                 * The new TypeReference<>() {} is the bit of magic required to have Jackson return a List with the
                 * correct type.
                 */
