...
import static edu.illinois.cs.cs124.ay2021.mp.models.Restaurant.search;
...
public final class MainActivity extends AppCompatActivity
  ...
  // private List<Restaurant> passToQuery;
  /*
  ...
  public boolean onQueryTextChange(final String query) {
    ...
    application
        ...
        .getRestaurants(
            (restaurants -> {
              listAdapter.edit().replaceAll(search(restaurants, query)).commit();
            }));
